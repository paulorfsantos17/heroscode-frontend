  ...
  return (
    <aside className="sidebar fixed bottom-0 right-0 top-16 z-10 h-screen w-[90px] overflow-y-auto bg-gray-100 text-xs text-blue shadow">
      <div className="h-full overflow-y-auto px-3 py-4">
        <SideBarItemMenu title="Home" icon={<AiOutlineHome size={30} />} />
        <SideBarItemMenu title="Mapa" icon={<LiaMapMarkedSolid size={30} />} />
        <SideBarItemMenu
        ...
        />
        <SideBarItemMenu title="SAC" icon={<BsQuestionCircle size={30} />} />
        <SideBarItemMenu
          title="Privacidade"
